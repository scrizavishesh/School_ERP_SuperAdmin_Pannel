                    ...
                    <ul className='p-0' >
                        ...
                        <li className={`nav-item pt-2 pb-2 sidebarlinks sidebarlinkborder ${ activeLink === 'addSchools' ?  `${sidebaropen? 'actionOptions': 'actionOptionsCollapsed'}`: ''}`}>
                           ...
                           <li className={`nav-item pt-2 pb-2 sidebarlinks ${ activeLink === 'systemSettings'||  activeLink === 'webSetting' ||  activeLink === 'manageFaq' ||  activeLink === 'paymentSettings' ?  `${sidebaropen? 'actionOptions': 'actionOptionsCollapsed'}`: ''}`}>
                            <Link to='/addons' dropdownopen={dropdownopen} onClick={() => { handleLinkClick('systemSettings','webSetting'); setDropDownOpen(!dropdownopen);}} className={`sidebbaroptions ${ activeLink === 'systemSettings'||  activeLink === 'webSetting' ||  activeLink === 'manageFaq' ||  activeLink === 'paymentSettings' ? 'text-white' : 'text-black' } border-top text-decoration-none`} >
                                <span className=' d-flex mb-0 p-1 ps-2' dropdownopen={dropdownopen}>
                                    ...
                                    <h2 className={`ms-1 ${sidebaropen? '':'sidebaroptiontext'} `}>Addon Details</h2>
                                </span>
                            </Link>
                        </li>

                        {
                            ...
                            <>
                                ...
                                <li className={`nav-item pt-2 pb-2 sidebarlinks sidebarlinkborder ${ activeLink === 'webSetting' ?  `${sidebaropen? 'actionOptions': 'actionOptionsCollapsed'}`: ''}`}>
                                    <Link to='/addaddon' onClick={() => { handleLinkClick('webSetting');}} className={`sidebbaroptions ${ activeLink === 'webSetting' ? 'text-white' : 'text-black' } border-top text-decoration-none`} >
                                        <span className=' d-flex mb-0 p-1 ps-2'>
                                            ...
                                            <h2 className={`ms-1 ${sidebaropen? '':'sidebaroptiontext'} `}>Add Addon</h2>
                                        </span>
                                    </Link>
                                </li>
                                <li className={`nav-item pt-2 pb-2 sidebarlinks sidebarlinkborder ${ activeLink === 'manageFaq' ?  `${sidebaropen? 'actionOptions': 'actionOptionsCollapsed'}`: ''}`}>
                                    <Link to='/AddFeature' onClick={() => { handleLinkClick('manageFaq');}} className={`sidebbaroptions ${ activeLink === 'manageFaq' ? 'text-white' : 'text-black' } border-top text-decoration-none`} >
                                        <span className=' d-flex mb-0 p-1 ps-2'>
                                            ...
                                            <h2 className={`ms-1 ${sidebaropen? '':'sidebaroptiontext'} `}>Features</h2>
                                        </span>
                                    </Link>
                                </li>
