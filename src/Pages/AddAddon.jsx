              ...
              <form>
                <div className="row">
                  <div className="col-md-4 col-sm-12">
                    ...
                    <input type="text" className="form-control p-2 formcontrolinput" id="BundleName" placeholder='Enter Addon Feature Name'/>
                  </div>
                  <div className="col-md-4 col-sm-12">
                  ...
                  <div className="col-md-4 col-sm-12">
                    ...
                    <input type="text" className="form-control p-2 formcontrolinput" id="BundleName" placeholder='Enter Identity Name'/>
                  </div>
                </div>
