  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
          ...
          <div className='d-flex g-1 for-media-query'>
            <form class="row  me-2">
              <div class="col-9 for-media-query-22">
                <input type="text" class="form-control form-control-sm form-focus" style={{ fontSize: '15px', width: '283px' }} id="inputPassword2" placeholder="01/01/2024 - 02/10/2024" />
              </div>
        ...
        <div className="main-content-conatainer p-2 ">
                      ...
                      <td className='  greyText'>
                        <div class="dropdown my-button-show">
                          ...
                          <ul class="dropdown-menu heading-14 anchor-color heading-14" >
                            ...
                            <li><Link class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop9090" aria-controls="staticBackdrop" onClick={(e) => { }}>View Details</Link></li>
