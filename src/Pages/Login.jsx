                                ...
                                <form className='pt-xl-3 pe-xl-5 ps-xl-5 pt-lg-2 pe-lg-2 ps-lg-2'>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="d-flex bg-white">
                                            <input type={showPassword ? 'text' : 'password'} className={`form-control formcontrolinputpass ${passError ? 'border-1 border-danger' : ''} `} id="exampleInputPassword1" placeholder='&#xf084; 6+ Strong Character' onChange={handlePassword} />
