            ...
            <div className="container-fluid">
                ...
                <div className="row overflow-scroll">
                    <ul className='p-0'>
                        ...
                        <li>
                            <Link to="/allSchoolsPage" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'schools' ? 'active' : ''}`} onClick={() => handleActiveLink('schools')} >
                                <Icon icon="uil:book-open" width="1.5em" height="1.5em" />
                                <h3 className="menu-text">Schools</h3>
                            </Link>
                        </li>
                        <li>
                            <Link to="/addSchoolsPage" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'addSchools' ? 'active' : ''}`} onClick={() => handleActiveLink('addSchools')} >
                                <Icon icon="bx:book-add" width="1.5em" height="1.5em" />
                                <h3 className="menu-text">Add School</h3>
                            </Link>
                        </li>
                        <li>
                            <Link to="/addons" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'addons' || activeLink === 'addAddons' || activeLink === 'addFeature' ? 'active' : ''}`} data-bs-toggle="collapse" data-bs-target="#collapseAddon" onClick={() => handleActiveLink('addons')} >
                                <Icon icon="mage:dashboard-2" width="1.5em" height="1.5em" />
                                <h3 className="menu-text">Addons</h3>
                            </Link>
                            <div id="collapseAddon" className="collapse collapse-menu p-0">
                                <ul className='list-unstyled p-0'>
                                    ...
                                    <li>
                                        <Link to="/addFeatures" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'addFeature' ? 'active' : ''}`} onClick={() => handleActiveLink('addFeature')} >
                                            <Icon className={``} icon="bi:grid-3x3-gap" width="24" height="24" />
                        ...
                        <li>
                            <Link to="/subscriptionPage" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'subscriptionPage' ? 'active' : ''}`} onClick={() => handleActiveLink('subscriptionPage')} >
                        ...
                        <li>
                            <Link to="/requestPage" className={`menus p-2 d-flex borderBottom ${sidebarOpen === '' ? 'justify-content-center' : ''} ${activeLink === 'requestPage' ? 'active' : ''}`} onClick={() => handleActiveLink('requestPage')} >
